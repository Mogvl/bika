  ...
  <div class="page-container">
    ...
    <div class="settings-group">
      <div class="setting-item">
        ...
        <button class="btn" @click="showChangePwd = true">修改</button>
      </div>
      <div class="setting-item">
...
.modal { background: rgba(255, 255, 255, 0.76); backdrop-filter: var(--glass-blur); -webkit-backdrop-filter: var(--glass-blur); border: 1px solid rgba(255, 255, 255, 0.7); box-shadow: var(--glass-highlight), var(--shadow); border-radius: var(--radius-lg); padding: 24px; width: 90%; max-width: 360px; display: flex; flex-direction: column; gap: 12px; }
