...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/category/comics', name: 'category-comics', component: () => import('@/views/CategoryComics.vue'), meta: { requiresAuth: true } },
    ...
    { path: '/local', name: 'local', component: () => import('@/views/LocalLibrary.vue'), meta: { requiresAuth: true } },
    { path: '/local-reader', name: 'local-reader', component: () => import('@/views/LocalReader.vue'), meta: { requiresAuth: true } },
    ...
    { path: '/help', name: 'help', component: () => import('@/views/Help.vue'), meta: { requiresAuth: true } },
  ],
})
